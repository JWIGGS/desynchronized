...
switch(returnType){
	case "x": return rotateAroundX + lengthdir_x(distance,angle) - lengthdir_y(distance,angle);
	case "y": return rotateAroundY + lengthdir_x(distance,angle) + lengthdir_y(distance,angle);
}
